    ...
    return (
        <div className="flex flex-col items-center justify-center m-5 p-5 bg-gray-100">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <label className="block text-orange-700 font-medium">Nama</label>
                <input type="nama" 
                placeholder="Masukkan Nama"
                className="w-full p-2 border-gray-300 rounded mb-2"/>
                ...
                <label className="block text-orange-700 font-medium">Tanggal Lahir</label>
                <input type="date" 
