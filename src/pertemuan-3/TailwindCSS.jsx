export default function TailwindCSS(){
    ...
    function Typography(){
        return (
            <div>
                <h1 className="text-3xl font-bold text-orange-600">Tailwind Typography</h1>
    ...
    function BorderRadius(){
        return (
            <button className="border-2 border-orange-500 text-orange-500 px-4 py-2 rounded-lg"> Klik Saya </button>
        )
    }
    ...
    function FlexboxGrid(){
        return (
            <nav className="flex justify-between bg-orange-800 p-4 text-white">
